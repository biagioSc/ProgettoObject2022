...
/**
 * The Class Studente: Apre il frame di registrazione utente studente.
 */
public class Studente extends JFrame {
	...
	/**
	 * Instantiates a new studente: Apre il frame di registrazione utente studente.
	 *
...
public Studente(Controller controller) {
	...
	lblNewLabel_1.setBounds(103, 81, 526, 36);
	contentPane.add(lblNewLabel_1);
	
	JLabel lblNewLabel_5 = new JLabel("Nome");
	lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD, 18));
	lblNewLabel_5.setBackground(Color.RED);
	lblNewLabel_5.setBounds(103, 134, 115, 24);
	...
	lblNewLabel_5_1.setBounds(103, 168, 115, 24);
	contentPane.add(lblNewLabel_5_1);
	
	JLabel lblNewLabel_6_1 = new JLabel("");
	lblNewLabel_6_1.setHorizontalAlignment(SwingConstants.CENTER);
	lblNewLabel_6_1.setFont(new Font("Tahoma", Font.BOLD, 13));
	lblNewLabel_6_1.setBounds(103, 307, 526, 22);
	...
	btnCliccaPerProseguire.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			try {
				controller.nuovoStudente(txtStud.getText(),textField_2.getText(),textField_3.getText(),textField_1.getText());
	...
	btnCliccaPerProseguire.setBounds(287, 339, 200, 24);
	...
	textField_1.setBounds(231, 170, 398, 25);
	...
	lblNewLabel_5_3.setBounds(103, 202, 115, 24);
	contentPane.add(lblNewLabel_5_3);
	
	JLabel lblNewLabel_6 = new JLabel("Password");
	lblNewLabel_6.setFont(new Font("Tahoma", Font.BOLD, 18));
	lblNewLabel_6.setBounds(103, 242, 97, 22);
