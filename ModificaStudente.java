...
/**
 * The Class ModificaStudente: mostra le informazioni dell'utente studente e ne salva eventuali modifiche.
 */
public class ModificaStudente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Window frame = null;
					ModificaStudente frame1 = new ModificaStudente(controller2, frame, toString(), toString(), toString());
	...
	/**
	 * Create the frame: mostra le informazioni dell'utente studente e ne salva eventuali modifiche.
	 *
...
public ModificaStudente(Controller controller1, Window frame,String username, String password, String matricola) {
	...
	JLabel lblNewLabel = new JLabel("Benevenuti nella sezione studente");
	...
	lblNewLabel_5_2_1.setBackground(Color.RED);
	lblNewLabel_5_2_1.setBounds(196, 168, 212, 24);
	contentPane.add(lblNewLabel_5_2_1);
	
	lblNewLabel_5_2.setText(username);
	lblNewLabel_5_2_1.setText(password);
	...
	btnCliccaPerProseguire.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			try {
				...
				controller1.modificaStudente(username,password,txtStud.getText(),textField_2.getText(),todaysDate);
	...
	btnCliccaPerProseguire.setBounds(208, 339, 178, 24);
	...
	txtStud.setBounds(245, 203, 163, 25);
	...
	JLabel lblNewLabel_2 = new JLabel("stud_");
	...
	btnEsci.setBounds(30, 339, 170, 24);
