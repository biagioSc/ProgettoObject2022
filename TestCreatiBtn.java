...
/**
 * The Class TestCreatiBtn: crea tabella con tutti i test creati da un utente insegnante e un operatore di selezione.
 */
public class TestCreatiBtn extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Window frame = null;
					TestCreatiBtn  frame1= new TestCreatiBtn(controller, frame, toString(),  toString(),toString());
	...
	/**
	 * Instantiates a new test creati btn: crea tabella con tutti i test creati da un utente insegnante e un operatore di selezione.
	 *
	 ...
	 */
	public TestCreatiBtn(Controller controller1, Window frame, String identificativo,String username, String password) throws Exception {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for(int i=0;i<table.getRowCount();i++) {
					...
					if(checked) {
						...
						try {
							frameTestCreati = new ModificaTest(controller1,frame,String.valueOf(table.getValueAt(i, 1)),username,password,identificativo);
	    ...
	    JLabel lblNewLabel_1_1 = new JLabel("Modifica Test");
