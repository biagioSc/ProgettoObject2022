...
/**
 * The Class AmmQMT (Ammette quiz multipli in test).
 */
public class AmmQMT extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Window frame = null;
					AmmQMT  frame1= new AmmQMT(controller, frame, toString(), toString(), toString());
	...
	/**
	 * Instantiates a new amm QMT: AmmQMT (Ammette quiz multipli in test).
	 *
	 ...
	 */
	public AmmQMT(Controller controller1, Window frame, String username, String password, String identificativo) throws Exception {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for(int i=0;i<table.getRowCount();i++) {
					...
					if(checked) {
						...
						try {
							setVisible(false);
							frameTestCreati = new InsertQMT(controller1,frame,String.valueOf(table.getValueAt(i, 1)),username,password,identificativo);
